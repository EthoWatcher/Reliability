...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../build-Agreement-Desktop_Qt_6_4_2_MinGW_64_bit-Release/release/ -lAgreement
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../build-Agreement-Desktop_Qt_6_4_2_MinGW_64_bit-Debug/debug/ -lAgreement
